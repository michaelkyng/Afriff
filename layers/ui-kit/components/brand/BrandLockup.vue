...
import BrandSubline from './BrandSubline.vue'
/** Stacked logo: emblem, AFRIFF wordmark and the festival name — as on afriff.com. */
withDefaults(defineProps<{ emblemSize?: number }>(), { emblemSize: 72 })
</script>
